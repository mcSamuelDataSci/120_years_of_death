...
workGroup1a_plot_df <- workGroup1a %>%
  ...
  ungroup() %>%
  mutate(cDeathRate = 100000*deaths/population) %>%
  mutate(barWidth = case_when( #year %in% c(1939) ~ 0.9, 
                              year %in% c(1920, 2020) ~ 2, 
                              year %in% c(1900, 1910, 1929, 1939, 1950, 1960, 1970, 1980, 1990, 2000, 2010) ~ 6, 
                              year %in% c(1917, 1918, 1919, 2018, 2019) ~ 0.5))
...
workGroup3_plot1 <- workGroup3_plot %>%
  ...
  mutate(type = ifelse(type == 'cDeathRate', "Crude Death Rate", "Number of Deaths"), 
         type = factor(type, levels = c("Number of Deaths", "Crude Death Rate")))
