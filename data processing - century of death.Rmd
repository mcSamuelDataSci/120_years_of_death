...
## Analyzing the past 100 years of mortality in California in order to identify patterns and create tools that will empower public health professionals to make more informed decisions.
## Creating useful visualizations of this mortality data.
...
names(workGroup1d) <- c("specificLevel", "2000CDC", "2000CCB", "2010CDC", "2010CCB", "2018CDC", "2018CCB")
