...
## Add 1930 and 1980.
## Add 2019 population data.
## Verify that 2019 and 2020 sorting are identical.
## Jaspreet and michael will talk about bringing in the ccb data with code.
## Address potential missclassification error around 1940-1950. This can be seen in the line plots.
## Get clinical consultation on this project.
## Kidney disease should be classified as other chronic. Figure out the "kidney disease and diabetes" issue.
...
## Move "non-core" charts to the end, such that the top bullets, titles, and charts is the "story" we would share with others.
## Add numbers to the chart titles.
