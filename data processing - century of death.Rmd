...
y1980 <- read_excel("CA 1900-2020 Project.xlsx",sheet="y1980") %>% mutate(year=1980)
...
ggplot(workGroup1a_plot_df, aes(x=year, y=cDeathRate, fill = topLevel, width = barWidth)) +
  ...
  labs(title = "1) Crude Death Rates (topLevel)",
       y = "Crude Death Rate per 100k Pop", x = "Cause of Death", caption = "Figure 1. Yearly crude death rate per 100,000 is stratified by topLevel with the purpose of revealing long-term mortality trends") +
  theme(plot.title = element_text(hjust = 0.5, size=30), 
...
ggplot(workGroup1a, aes(x=fct_rev(specificLevel), y=deaths, fill = topLevel)) +
  ...
  labs(title = "2) Number of Deaths as Sorted by specificLevel",
       caption = "Figure 2. Change in specificLevel mortality between 1900 and 2020 grouped by topLevel. Each year has an x-axis of varying magnitude, depending on the number of deaths in that year.",
...
ggplot(workGroup3, aes(x=year, y=deaths, color=topLevel)) +
  ...
  theme(legend.key.size = unit(1, 'cm'), 
        ...
        legend.title = element_text(size=17), 
        legend.text = element_text(size=13)) +
  labs(title = "4) Number of Deaths (topLevel Line Plot)",
...
ggplot(workGroup3, aes(x=year, y=cDeathRate, color=topLevel)) +
 theme(axis.text.x = element_text(size=15), axis.text.y = element_text(size=15), axis.title.x = element_text(size=22), axis.title.y = element_text(size=22)) +
  ...
  theme(legend.key.size = unit(1, 'cm'), 
        ...
        legend.title = element_text(size=17), 
        legend.text = element_text(size=13)) +
  labs(title = "5) Crude Death Rate per 100,000 (topLevel Line Plot)", 
       caption = "Figure 5. INSERT CAPTION",
